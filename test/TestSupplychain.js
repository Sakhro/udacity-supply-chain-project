...
contract('SupplyChain', function (accounts) {
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async () => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const { itemState } = await supplyChain.fetchItemBufferTwo.call(upc)

        // Verify the result set
        assert.equal(itemState, 1, 'Error: Invalid item State')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne.ownerID, distributorID, 'Error: Invalid ownerID')
        assert.equal(resultBufferTwo.distributorID, distributorID, 'Error: Invalid distributorID')
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne.ownerID, retailerID, 'Error: Invalid ownerID')
        assert.equal(resultBufferTwo.retailerID, retailerID, 'Error: Invalid retailerID')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async () => {
        ...
        assert.equal(resultBufferTwo[3], productNotes, "Error: Invalid item Note")
